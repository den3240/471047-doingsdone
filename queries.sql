...
INSERT INTO `projects` (`name`, `user_id`) VALUES ('Все', 3), ('Входящие', 3), ('Учеба', 3), ('Работа', 3), ('Домашние дела', 3), ('Авто', 3);

/* Добавляю данные в таблицу tasks */
INSERT INTO `tasks` (`name`, `deadline`, `user_id`, `project_id`) VALUES ('Собеседование в IT компании', '2018-02-12', 3, 4), ('Выполнить тестовое задание', '2018-06-25', 3, 4), ('Сделать задание первого раздела', '2018-02-22', 3, 3), ('Встреча с другом', '2018-02-10', 3, 2), ('Купить корм для кота', '', 3, 5), ('Заказать пиццу', '', 3, 5);
